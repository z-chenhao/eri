...
- [DeepSeek Tool Calls](https://api-docs.deepseek.com/guides/tool_calls/), [context cache](https://api-docs.deepseek.com/guides/kv_cache/), and [thinking mode](https://api-docs.deepseek.com/guides/thinking_mode/)
